            ...
            <div className="relative rounded-full p-2 border-[1px] border-gray-300">
              <button className="absolute top-1/2 left-2 -translate-y-1/2 text-black">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M10.5423 19.2499C15.3518 19.2499 19.2507 15.3511 19.2507 10.5416C19.2507 5.73211 15.3518 1.83325 10.5423 1.83325C5.73284 1.83325 1.83398 5.73211 1.83398 10.5416C1.83398 15.3511 5.73284 19.2499 10.5423 19.2499Z" stroke="#596780" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M20.1673 20.1666L18.334 18.3333" stroke="#596780" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
              </button>
